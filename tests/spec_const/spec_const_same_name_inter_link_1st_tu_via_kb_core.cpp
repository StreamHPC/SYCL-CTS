...
#include "spec_const_same_name_inter_link.h"

#define TEST_NAME spec_const_same_name_inter_link_1st_tu_via_kb_core
...
class TEST_NAME : public sycl_cts::util::test_base {
 public:
  ...
  void run(util::logger &log) override {
    using namespace spec_const_same_name_inter_link;
