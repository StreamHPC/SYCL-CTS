...
//
//  Provides tests for specialization constants throwing exceptions when
expected
//
*******************************************************************************/
...
#include "spec_const_exceptions_throwing_common.h"

#define TEST_NAME spec_const_exceptions_throwing_core
  ...
  void run(util::logger &log) override {
    {
      ...
      for_all_types_vectors_marray<
          check_spec_constant_exception_throw_for_type>(
          get_spec_const::testing_types::types, log);
#endif
      for_all_types<check_spec_constant_exception_throw_for_type>(
