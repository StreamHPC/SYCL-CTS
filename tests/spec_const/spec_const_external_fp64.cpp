...
#define TEST_NAME spec_const_external_fp64
 ...
 public:
  ...
  void run(util::logger &log) override {
    ...
    using namespace spec_const_external;
    {
      ...
      check_spec_const_external<double> fp64_test{};
      fp64_test(log, "double");
#else
      for_type_vectors_marray<check_spec_const_external, double>(log, "double");
#endif
    }
#endif  // SYCL_EXTERNAL
  }
