...
//
// Provides tests for specialization constants usage via handler for sycl::half
//
*******************************************************************************/

#include "../common/common.h"
#include "../common/type_coverage.h"
#include "spec_const_via_handler_common.h"

#define TEST_NAME spec_const_via_handler_fp16
...
class TEST_NAME : public sycl_cts::util::test_base {
 public:
  ...
  void run(util::logger &log) override {
    using namespace spec_const_via_handler_common;
    {
